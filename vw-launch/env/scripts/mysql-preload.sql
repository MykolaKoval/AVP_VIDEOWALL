...
CREATE TABLE displays (
	...
	resolution VARCHAR(32) NULL DEFAULT NULL,
	orientation VARCHAR(32) NULL DEFAULT NULL,
...
CREATE TABLE layouts (
	...
	name VARCHAR(32) NULL DEFAULT NULL,
	create_ts DATETIME NULL DEFAULT NULL,
	layout_blob LONGTEXT NULL DEFAULT NULL,
	PRIMARY KEY (id)
);
	
CREATE TABLE layout_windows (
	id BIGINT NOT NULL AUTO_INCREMENT,
	name VARCHAR(32) NULL DEFAULT NULL,
	left_pct INT NULL DEFAULT NULL,
	top_pct INT NULL DEFAULT NULL,
	height_pct INT NULL DEFAULT NULL,
